...
- Comments and private notes remain separate, deferred concepts. The next decision is how user-visible signals and explicit human actions crystallize a Conversation into durable Product Knowledge, a Decision, an update or an Open Question.

See `2026-07-24-project-conversations-workspace.md`, `2026-07-24-bring-your-own-ai.md`, `2026-07-24-personal-ai-assistants.md`, `2026-07-24-conversation-recipients-and-assistant-terminology.md`, `2026-07-24-conversation-recipient-management.md`, `2026-07-24-conversation-completion.md`, `2026-07-24-conversation-closure-and-list-organization.md` and `2026-07-24-conversation-initiation-matrix.md`.
