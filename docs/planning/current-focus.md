...
- Content Locale now explicitly governs document-facing template scaffolding, while Interface Locale remains responsible for workbench controls and validation. Authored content is never automatically translated.
