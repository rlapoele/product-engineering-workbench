...
- **Fonts and typography:** Source Sans 3 gives the implementation a closely related humanist sans texture. Heading weight, document hierarchy, body line height and wrapping preserve the source's Craft-led reading character. The implementation uses a slightly larger prose scale to keep the live document comfortable and legible; the focused comparison shows that this remains visually coherent rather than changing the hierarchy.
- **Spacing and layout rhythm:** The desktop keeps the reference's quiet left outline, broad document surface and contextual right region. Opening review context narrows the document while retaining FR-012 in view. At 390 and 320 pixels, the outline becomes an overlay and review context enters the document flow; no horizontal overflow occurs.
...
9. Switch between ochre and blue treatments.
